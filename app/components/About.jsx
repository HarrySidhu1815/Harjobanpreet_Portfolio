    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex flex-col lg:flex-row items-center gap-20 my-20 w-full'>
        ...
        className='flex-1'>
            ...
            className='grid sm:grid-cols-3 grid-cols-1 gap-6 max-w-2xl'>
            ...
            className='flex items-center gap-3 sm:gap-5'>
                {toolsData.map((tool, index) => (
                    ...
                    className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500' key={index}><Image src={tool} alt='tool' className='w-5 sm:w-7'/></motion.li>
                ))}
            </motion.ul>
        </motion.div>
      </motion.div>
